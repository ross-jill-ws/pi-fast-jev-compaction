// Vendored from fast-jev-compaction (MIT, https://github.com/tamaratran/fast-jev-compaction), src/types.ts.
// Adapted for pi: .ts import specifiers; see compact.ts/client.ts for the pi-specific changes.
...
export interface CompactResult {
  ...
  /** Every tool call that was paired with a result, pinned or not (maps `id` to `tool_use_id`). */
  calls: ToolCall[];
  stats: {
    ...
    requests: number;
    ms: number;
    /** Tokens Jev reported for all requests, 0 when unreported. */
